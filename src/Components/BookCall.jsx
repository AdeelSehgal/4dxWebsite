...
const BookCall = () => {
    ...
    return (
        <div className='lg:flex justify-center items-center py-4 bg-[#fff]'>
            <div className='lg:w-[42%] sm:w-[95%] bg-[#c9ff00] mb-5 p-7 rounded-2xl mx-4 flex justify-around items-center hover:-translate-y-5 duration-150 transition-all'>
                <div className='w-[60%]'>
            ...
            <div className='lg:w-[42%] sm:w-[95%] border border-zinc-300 mb-5 p-7 rounded-2xl mx-4 flex justify-around items-center hover:-translate-y-5 duration-150 transition-all'>
                <div className='w-[60%]'>
