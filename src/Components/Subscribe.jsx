...
const Subscribe = () => {
    ...
    useEffect(() => {
        ...
        if (oneRef.current) {
            gsap.fromTo(oneRef.current, { y: 30, opacity: 0 }, {
                y: 0,
                opacity: 1,
                scrollTrigger: {
                    trigger: oneRef.current,
                    start: "top 50%", // When the top of myboxRef reaches the center of the viewport
                    end: "top 40%", // When the center of myboxRef reaches the center of the viewport
                    scrub: 1, // Smoothly scrubs the animation
                    markers: false, // Uncomment this to see the start and end markers
                }
            });
        ...
        if (twoRef.current) {
            gsap.fromTo(twoRef.current, { y: 30, opacity: 0 }, {
                y: 0,
                opacity: 1,
                scrollTrigger: {
                    trigger: twoRef.current,
                    start: "top 80%", // When the top of myboxRef reaches the center of the viewport
                    end: "top 40%", // When the center of myboxRef reaches the center of the viewport
                    scrub: 1, // Smoothly scrubs the animation
                    markers: false, // Uncomment this to see the start and end markers
                }
        ...
        if (threeRef.current) {
            gsap.fromTo(threeRef.current, { y: 30, opacity: 0 }, {
                y: 0,
                opacity: 1,
                scrollTrigger: {
                    trigger: threeRef.current,
                    start: "top bottom", // When the top of myboxRef reaches the center of the viewport
                    end: "top 40%", // When the center of myboxRef reaches the center of the viewport
                    scrub: 1, // Smoothly scrubs the animation
                    markers: false, // Uncomment this to see the start and end markers
                }
            ...
            <div className='md:w-[40%] relative mt-10'>
                <div className='flex flex-col gap-24  '>
                    <div className='flex justify-center items-start gap-4 '>
                        <div className='border relative z-10 border-zinc-800 rounded-full px-4 py-3 font-medium text-zinc-600 mt-3'>
                            <div className='' ref={oneRef}>01</div>
                        </div>
                        <div className=' '>
                    ...
                    <div className='flex justify-center items-start gap-4'>
                        <div className='border border-zinc-800 bg-[#fff] mt-3  relative z-10 rounded-full px-4 py-3  font-medium text-zinc-600'>
                            <div ref={twoRef}>02</div>
                        </div>
                        <div className=''>
                    ...
                    <div className='flex justify-start items-start gap-4 relative z-10 bg-[#fff]  '>
                        <div className='border col3  border-zinc-800 rounded-full   px-4 py-3 font-medium text-zinc-600 '>
                            <div ref={threeRef}>03</div>
                        </div>
                        <div className=''>
