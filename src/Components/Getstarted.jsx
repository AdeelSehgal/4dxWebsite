...
const Getstarted = () => {
  return (
    <div className='relative bg-[#fff] rounded-b-[50px] h-[150vh] overflow-hidden  py-10'>
      <h4 className='lg:text-[11rem] text-[8rem] font-bold text-center  pt-40 z-10'>Get Started</h4>
