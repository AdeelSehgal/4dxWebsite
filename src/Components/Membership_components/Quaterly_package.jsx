...
const Quaterly_package = () => {
    return (
        <div className='flex justify-center items-center mt-7 '>
            ...
            <div className='w-[27%] mx-4 py-7 bg-[#f7f7f8] px-10  rounded-xl border relative border-zinc-300 hover:-translate-y-5 duration-150 transition-all'>
                <div className="banner bg-[#c9ff00]  p-2 w-fit font-semibold text-[12px] rounded-lg absolute -top-5 right-32">Best Value</div>
