            ...
            <div className='md:px-12  bg-white z-[2] relative rounded-b-3xl pb-10 md:mb-[100vh]  pt-[50px]'>
                ...
                <div className='md:px-12 px-4 my-3'>
                    ...
                    <p className='text-[18px] text-[#858585] my-4 '>The type of Personal Data (defined below) and Other Data (also defined below) we collect depends on how you are specifically interacting with this Site how you are using our Services. Generally, we gather Personal Data and Other Data as described below.
                        <br /><br />
                        Personal data is information that identifies you or can be used to identify or contact you, e.g., your name, email address, address, usage data, phone numbers, and unique device identifiers (“Personal Data”).  We may need to collect and process Personal Data in order to provide requested information, products or Services to you (including this Site) or because we are legally required to do so. <br /> <br />

                        1. Account Registration.  We requests Personal Data from you if this Site requires registration.  The registration process requests that you provide your name, email address, address, phone number, company affiliation, tax information if any, and other similar information.  This information must be stored on this Site, and is accessible to anyone with whom you share your username and password. For this reason, please safeguard your username and password carefully and do not disclose it to any other person. <br /> <br />
                        2. Voluntary Disclosure.  We may collect Personal Data voluntarily provided by you, including in emails to this Site, online forms, order and registration forms, surveys, promotion participation, phone calls and online chats with our customer service and through other means. <br /> <br />
                        Payment Services.  We may use third-party payment Services (each, a “Payment Service”) to collect payments made through this Site.  If you wish to make a payment through this Site, you may be directed to a webpage that is hosted by the Payment Service (or the Payment Service’s service providers) and not by us.  Any Personal Data that you provide through a Payment Service page will be collected by Payment Service and not by us, and will be subject to Payment Service’s privacy policy, rather than this Policy.  We have no control over, and are not responsible for, Payment Service’s use of information collected through the Payment Service page. <br />  <br />
                        3. Log data. We may collect log data, such as network and connection information (including Internet Service Provider (ISP) and Internet Protocol (IP) addresses), device and browser identifiers and information (including device, application, or browser type, version, plug-in type and version, operating system, user agent, language and time zone settings, and other technical information), advertising identifiers, cookie identifiers and information, and similar data.
                ...
                <div className='md:px-12 px-4 my-3'>
                    ...
                    <p className='text-[18px] text-[#858585] my-4 '>Our primary goal in collecting, using, and sharing your information is to enhance and improve our Services. To that end, we will only use Personal Data for legitimate business purposes, including the following: <br /> <br />
                        ...
                        We may disclose Personal Data for the following purposes: <br /> <br />

                        Third-Party Service Providers.  We may provide Personal Data to third-party service providers, who provide services to us, including but not limited to, data analysis, order fulfillment, payment processing, and other services. <br /> <br />
                        ...
                        Promotions.  We may share the Personal Data you provide in connection with Promotions with third-party sponsors of such Promotions (irrespective of whether such Promotions are hosted by us), or otherwise in accordance with the rules applicable to those Promotions. <br /> <br />
                ...
                <div className='md:px-12 px-4 my-3'>
                    ...
                    <p className='text-[18px] text-[#858585] my-4 '>Our service providers and we may also collect and use the following types of data, referred to in this Policy as “Other Data <br /> <br />
                        ...
                        ‍
                        Strictly Necessary. These cookies are essential for our Services to perform their basic functions. These include cookies that are required to allow registered users to authenticate and perform account related functions, as well as to save the contents of virtual “carts” for e-commerce functionality. <br /> <br />
                        ‍
                        Analytics and Performance. Performance cookies collect information on how users interact with our Services, including what pages are visited most, as well as other analytical data. We use these details to improve how our Services function and to understand how users interact with our Services. <br /> <br />
                        ‍
                        Functionality. These cookies are used to store preferences set by users, such as account name and language. <br /> <br />
                        ‍
                        Security. We use these cookies to help identify and prevent potential security risks. <br /> <br />
                        ‍
                        Advertising. These cookies are used to display relevant advertising to users who use our Services, as well as to understand and report on the efficacy of ads served on our Services. They track details such as the number of unique visitors, the number of times particular ads have been displayed, and the number of clicks the ads have received. They are also used to build user profiles, including showing you ads based on products or Services you’ve viewed or acts you have taken. <br /> <br />
                        ...
                        IP Addresses. When you visit and interact with this Site, we and our third-party service providers may collect Internet Protocol (IP) addresses.  Your IP address is a number that is automatically assigned to the computer that you are using by your Internet Service Provider (ISP).<br /> <br />  This number is identified and logged automatically in our server log files whenever you visit this Site, along with the time(s) of your visit(s) and the page(s) that you visited.<br /> <br />
                        We use IP addresses to understand how this Site is used by our users, to improve this Site and to enhance user experience of this Site.  We may also use your IP address to help diagnose problems with our server and to administer our Site.  We may also derive your approximate location from your IP address..</p>
                </div>
                ...
                <div className='md:px-12 px-4 my-3'>
                    ...
                    <p className='text-[18px] text-[#858585] my-4 '>We give you choices regarding our use and disclosure of your Personal Data for marketing purposes.
                        ...
                        If you no longer want to receive marketing-related emails from us on a going-forward basis, you may stop receiving these marketing-related emails by sending an email to hi@wewantdesign.co. <br /><br />
                        ‍
                        If you would prefer that we do not share your Personal Data on a going-forward basis with our affiliates or with unaffiliated third parties for their marketing purposes, you may cease this sharing by sending an email to hi@wewantdesign.co. <br /> <br />
                        ...
                        You may also indicate your choices regarding marketing-related emails by contacting us via postal mail or telephone using our contact information below, or if you have a profile/account, by changing your preferences on the profile/account at any time.</p>
                </div>
                ...
                <div className='md:px-12 px-4 my-3'>
                    ...
                    <p className='text-[18px] text-[#858585] my-4 '>Use of this Site is governed by United States law and the laws of the State of Wyoming.  If you are accessing this Site or Services from a physical location outside of the United States with laws or regulations governing personal data collection, use, and disclosure that are different from United States laws, you agree that by accessing this Site, you are transferring your Personal Data and Other Data to the United States and you consent to the application of the laws of the United States and the State of Wyoming with respect to use of this Site and Services and any dispute regarding this Site or this Policy. <br />
                        ...
                        If any provision of this Policy is held by a court of competent jurisdiction to be illegal, unenforceable, or in conflict with any applicable law, the validity of the remaining portions or provisions shall remain in full force and effect.</p>
                </div>
                ...
                <div className='md:px-12 px-4 my-3'>
                    ...
                    <p className='text-[18px] text-[#858585] my-4 '>Your Personal Data may be stored and processed in any country where we have facilities or in which we engage service providers.  If you are accessing this Site from outside the United States, you may be sending information, including Personal Data to the United States where our servers are located.  That information may be transferred within the United States or back out of the United States to other countries outside your country of residence. <br />
                        ...
                        Information transferred to the United States or another country is subject to the laws of that country and may be disclosed or accessed in accordance with those laws.  By transferring information or allowing information to be transferred to us, you consent to the transfer, processing and storage in countries outside your country of residence. <br />
