...
const PhysicsBars = () => {
  ...
  useEffect(() => {
    ...
    const boxes = [];
    const texts = [
      'Limited Scalabilty', 'Recruitment and Training', 'Employee Turnover',
      'Wasting Time on Hiring', 'High Overhead Cost', 'Lack of Externat Insights',
      'Limited Flexibility', 'Narrow Experties', 'Resource Competetion'
    ];
