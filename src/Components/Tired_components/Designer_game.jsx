...
const PhysicsBars = () => {
  ...
  useEffect(() => {
    ...
    const boxes = [];
    const texts = [
      'Resource Competition', 'Wasting Time on Hiring', 'High Overhead Cost',
      'Employee turnover', 'Narrow Experties', 'Lack of External Insights',
      'Limited Flexibility', 'Limited Scalibility', 'Recruitment and Training'
    ];
