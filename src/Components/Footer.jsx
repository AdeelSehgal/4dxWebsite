                ...
                <div className="fifth text-white text-[40px] font-semibold w-[25%]">
                    ...
                    <div className='flex items-center gap-3'>
                        ...
                        <div className='bg-[#c9ff00] letstalk'>
                            <img src="https://cdn.prod.website-files.com/646c6ec121d9bb039374fb89/64d5d79abf8d81d90a15c7aa_Vector%20(3).svg" alt="Black Arrow"  ></img>
                        </div>
                    </div>
                </div>
            </div>
            <div className='flex justify-between items-center text-white bg-black border border-slate-900 p-4 px-16'>
                <div>We Want Design © 2023</div>
                <div className='text-zinc-500 flex justify-evenly items-center gap-x-8'>
                    <div className='cursor-pointer text-sm hover:text-white'>Manage Subscription</div>
                    <div className='cursor-pointer text-sm hover:text-white'>Terms of Serivces</div>
                    <div className='cursor-pointer text-sm hover:text-white' >Privacy Policy</div>
                </div>
            </div>
            <div className='bg-black border border-slate-900 p-6'></div>
        </div>
    )
}
